  ...
  return (
    ...
    >
      <NavItem label="Tìm kiếm nhanh" icon={<Search size={24} />}>
        <a href="/product" style={{ display: "block", padding: "5px 0" }}>
          Theo thương hiệu
        </a>
        <a href="/product" style={{ display: "block", padding: "5px 0" }}>
          Theo kích cỡ
      ...
      <NavItem label="Thiết bị điện - Dây cáp điện" icon={<CircuitBoard size={24} />}>
        <a href="/product" style={{ display: "block", padding: "5px 0" }}>Nike Air</a>
        <a href="/product" style={{ display: "block", padding: "5px 0" }}>Adidas Neo</a>
      </NavItem>
      <NavItem label="Thiết bị Vệ sinh cao cấp" icon={<Toilet size={24} />}>
        <a href="/product" style={{ display: "block", padding: "5px 0" }}>Ba sọc đen</a>
        <a href="/product" style={{ display: "block", padding: "5px 0" }}>Ba sọc trắng</a>
      </NavItem>
